FactoryGirl.define do
  factory :stock_transfer, class: Spree::StockTransfer do
    source_location { Spree::StockLocation.create!(name: "Source Location", admin_name: "Source") }

    factory :stock_transfer_with_items do
      destination_location { Spree::StockLocation.create!(name: "Destination Location", admin_name: "Destination") }
